...
```{r}
unique(unlist(EDH_clean$material))
```
...
write(EDH_cleaned_json, file="EDH_attrs_cleaned_2020-09-17.json")
user <- readline("your sciencedata username: ")
request("EDH_attrs_cleaned_2020-09-17.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/EDH/",
        method="PUT", cred=c(user, getPass("your sciencedata password: ")))
```

# Remove local copy of the json
```{r}
file.remove("./EDH_attrs_cleaned_2020-09-17.json")
```
