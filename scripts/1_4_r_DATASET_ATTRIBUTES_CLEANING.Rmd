...
write(EDH_cleaned_json, file="EDH_attrs_cleaned_2020-09-25.json")

user <- readline("your sciencedata username: ")
request("EDH_attrs_cleaned_2020-09-25.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/EDH/public",
...
```{r}
file.remove("./EDH_attrs_cleaned_2020-09-25.json")
```
