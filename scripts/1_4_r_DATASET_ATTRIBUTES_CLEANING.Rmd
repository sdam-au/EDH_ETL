...
#insc_typology_api$type_of_inscription <- unlist(insc_typology_api$type_of_inscription, use.names = F)
#insc_typology_xml$keywords_term_text <- unlist(insc_typology_xml$keywords_term_text, use.names = F)
...
write(EDH_cleaned_json, file="EDH_attrs_cleaned_2020-09-28.json")

#user <- readline("your sciencedata username: ")
request("EDH_attrs_cleaned_2020-09-28.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/EDH/public",
...
```{r}
file.remove("./EDH_attrs_cleaned_2020-09-28.json")
```
