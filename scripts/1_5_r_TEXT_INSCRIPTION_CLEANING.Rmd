...
```
## Loading data
1. Load the dataset either locally or from sciencedata.dk (if you have not run the previous script)

```{r, loading data}

list_json <- jsonlite::fromJSON("../data/large_data/EDH_attrs_cleaned_2022-11-03.json")
#list_json <- jsonlite::fromJSON(resp)
EDH_clean <- as_tibble(list_json)

# or from sciencedata (you need a mysecret.txt file)
#mycred_secret<- readLines("~/mysecret.txt")
#resp = request("EDH_attrs_cleaned_2022-11-03.json", path="/sharingin/648597@au.dk/SDAM_root/SDAM_data/EDH/public", method="GET", cred=mycred_secret)
#list_json <- rjson::fromJSON(resp)
#EDH_clean <- as_tibble(list_json)
...
write(EDH_cleaned_json, file="data/large_data/EDH_text_cleaned_2022-11-03.json")
```

```{r}
user <- readline("your sciencedata username: ")
request("data/large_data/EDH_text_cleaned_2022-11-03.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/EDH/public",
