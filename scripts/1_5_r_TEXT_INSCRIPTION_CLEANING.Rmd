...
```{r}
EDH <- jsonlite::fromJSON("https://sciencedata.dk/public/b6b6afdb969d378b70929e86e58ad975/EDH_attrs_cleaned_2022-11-03.json")
```

Or load local dataset
```{r}
getwd()
EDH <- jsonlite::fromJSON("../data/EDH_attrs_cleaned_2022-11-03.json")
```
