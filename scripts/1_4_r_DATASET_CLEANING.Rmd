...
```{r, echo = FALSE }
resp = request("EDH_merged_2020-06-23.json", path="/sharingin/648597@au.dk/SDAM_root/SDAM_data/EDH/", method="GET", cred=c(user, getPass("your sciencedata password: ")))
```
...
## 4. Checking there are no type of inscriptions with question mark
```{r}
...
## 2. Creating new column `material_clean` with main categories of the material based on Regular Expressions
```{r}
...
write(EDH_cleaned_json, file="EDH_cleaned_2020-06-26.json")
user <- readline("your sciencedata username: ")
request("EDH_cleaned_2020-06-26.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/EDH/",
